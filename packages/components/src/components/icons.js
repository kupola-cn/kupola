 ...
 *
 * Provides an SVG icon registry with rendering utilities.
 ...
 * const bigCheck = svg('check', 24);
 *
 * // Render all data-icon elements
 * Icons.render();
 *
 * // Register custom icons
 * Icons.registerIcons({ 'my-icon': '<circle cx="12" cy="12" r="10"/>' });
 * ```
 *
...
const INTERFACE_ICONS = {
  ...
  'settings':    '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>',
...
const DATA_ICONS = {
  'table':       '<rect x="3" y="3" width="18" height="18"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/>',
...
function registerGroup(groupName) {
  ...
  if (group) {
    Object.assign(PATHS, group);
    return true;
  }
  return false;
}

function registerAllGroups() {
