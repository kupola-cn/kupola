      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'useQuery 请求缓存', link: '/guide/use-query' },
            { text: 'useForm 表单状态', link: '/guide/use-form' },
            { text: 'CSS Modules 作用域样式', link: '/guide/css-modules' },
            { text: '主题系统', link: '/guide/theme-system' },
            { text: 'DevTools 开发调试', link: '/guide/devtools' },
            { text: 'effectScope 显式生命周期', link: '/guide/effect-scope' },
            { text: 'lazyComponent 懒加载', link: '/guide/lazy-component' },
            { text: 'TypeScript 指南', link: '/guide/typescript' },
